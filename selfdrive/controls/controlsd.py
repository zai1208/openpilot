...
from selfdrive.controls.lib.drive_helpers import update_v_cruise, initialize_v_cruise, V_CRUISE_NA
...
class Controls:
  ...
  def state_transition(self, CS):
    ...
    else not CS.cruiseState.available:
      self.v_cruise_kph = V_CRUISE_NA
